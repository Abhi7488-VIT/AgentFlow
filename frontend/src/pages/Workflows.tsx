      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-white/5">
            {loading ? (
              <tr><td colSpan={4} className="p-8 text-center text-gray-400">Loading workflows...</td></tr>
            ) : workflows.length === 0 ? (
              <tr><td colSpan={4} className="p-8 text-center text-gray-400">No workflows found. Start a new research task!</td></tr>
            ) : (
              workflows.map((wf) => (
                <tr key={wf.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="p-4 text-gray-400">{new Date(wf.created_at).toLocaleDateString()}</td>
