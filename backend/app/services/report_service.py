...
def generate_pdf(report: Report) -> bytes:
    try:
        ...
        def _page_chrome(canvas_obj, doc):
            ...
            canvas_obj.drawString(40, H - 26, 'AgentFlow AI — Product Intelligence Report')
            ...
            canvas_obj.drawString(40, 9, 'Confidential — Generated by AgentFlow AI')
        ...
        flow.append(Paragraph('Generated by <b>AgentFlow AI</b>', s_cover_meta))
        ...
        flow.append(Paragraph(
            'This report was generated autonomously by the AgentFlow AI multi-agent pipeline. '
